...
class userInfo {
  ...
  let friendOne = new friendInfo(0,"tonybaloney", './img/tonybaloney.jpg', '');

  let sampleFriendList = [];
  sampleFriendList.push(friendOne)

  let hammerAlbum  = new albumInfo(0, " Please Hammer Don’t Hurt ‘Em ", './img/please_hammer_dont_hurt_em.jpg');
  let noteWorthyAlbum  = new albumInfo(1, "Bahen...", './img/Bahen....jpg');
  let helpAlbum  = new albumInfo(2, "Help!", './img/help.jpg');

  let sampleFavAlbumList = [];
  sampleFavAlbumList.push(noteWorthyAlbum);

  let nothworthyReview = new reviewData( new Date(2020, 11, 12),1, "Bahen… ",'./img/bahen....jpg',
  ...
  let cscUser = new userInfo(1,"csc309 ",'./img/csc309.jpg',
